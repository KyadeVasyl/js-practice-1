...
console.log("getUserStatus(70)", getUserStatus(65)); // Виведе: "Пенсіонер"
...
function getDayOfWeek(dayNumber) {
  ...
  switch (dayNumber) {
    ...
    case 7:
      day = "Неділя";
      break;
    default: day = "Невірний номер дня";
  } return day;
...
// Задача 12: створити функцію `makeAdder`, яка приймає число `x` 
// і повертає нову функцію, що приймає число `y` і повертає суму `x` та`y`
...
// Задача 15: Створити мемоізовану версію функції,
// яка обчислює площу квадрата на основі довжини його сторони.
